...
class _ScanResultTileState extends State<ScanResultTile> {
      ...
      return Column(
        ...
        children: <Widget>[
          ...
          Text(
            ...
            style: TextStyle(color: Colors.white, fontSize: 11),//Theme.of(context).textTheme.bodySmall,
          )
        ],
      );
    } else {
  ...
  Widget _buildConnectButton(BuildContext context) {
    return ElevatedButton(
      child: isConnected ? const Text('OPEN', style: TextStyle(color: Colors.white),) : const Text('CONNECT', style: TextStyle(color: Colors.white)),
  ...
  Widget build(BuildContext context) {
    ...
    return ExpansionTile(
      ...
      leading: Text(widget.result.rssi.toString(), style: TextStyle(color: Colors.white),),
