...
class _JoystickState extends State<Joystick> {
    ...
    return Stack(
      ...
      children: [
        ...
        GestureDetector(
          ...
          onPanEnd: (details) => (widget.block) ? null : _stickDragEnd(),
          child: widget.stick,
        ),
      ],
    );
  ...
  void _stickDragUpdate(Offset globalPosition) {
    //debugPrint('globalPositionU $globalPosition');
    final baseRenderBox =
